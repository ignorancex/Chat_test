...
public class ChatActivity extends BaseActivity {
    ...
    private void sendMessage(){
        ...
        if(conversionId!=null){
            ...
            coversion.put(Constants.KEY_RECEIVER_ID,receiverUser.id);
            coversion.put(Constants.KEY_RECEIVER_NAME,receiverUser.name);
            coversion.put(Constants.KEY_RECEIVER_IMAGE,receiverUser.image);
